<?php
$myDelNo = $_REQUEST['myDelNo'];
try {
	require_once("connectCd102g2.php");
	$sql = "delete from myschedule where memNo=$myDelNo";
	$delTravelRow =  $pdo->exec($sql);


	$sql2="select * from expert,myschedule where expert.expertNo=myschedule.expertNo and share=1";
	$myschedule = $pdo->query($sql2);
